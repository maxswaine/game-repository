...
5. Use a flat numbered list — every rule gets its own number. Do NOT group rules under a parent item with sub-bullets. Do NOT use nested lists. Separate each numbered rule with a blank line.
